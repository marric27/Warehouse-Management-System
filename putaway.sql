...
-- Dump dei dati della tabella wms.customers: ~2 rows (circa)
...
-- Dump dei dati della tabella wms.orders: ~0 rows (circa)
...
-- Dump dei dati della tabella wms.sales_order_line: ~0 rows (circa)
