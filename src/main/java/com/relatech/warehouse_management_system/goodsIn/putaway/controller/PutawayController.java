...
public class PutawayController {
    ...
    public ResponseEntity<SlotDTO> assignStockUnitToSlot(@PathVariable Long stockUnitId, @PathVariable Long slotId) throws UpdateEntityException, ResourceNotFoundException {
